	...
	def create_twitter_posts(self, agent, niche):
		return Task(
			description=dedent(f"""\
				...
				Next, Create 3 Twitter posts related to {niche} using the content research done for each of 
				...
				Task should return an array containing all the 3 twitter posts"""),
